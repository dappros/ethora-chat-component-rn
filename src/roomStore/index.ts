// Import polyfill for crypto.getRandomValues before any crypto operations
...
const chatSettingPersistConfig = {
  ...
  blacklist: [
    ...
    'config.eventHandlers', // Don't persist eventHandlers (functions can't be serialized)
    'refreshTokens',
    'client',
  ],
    ...
    getDefaultMiddleware({
      ...
      serializableCheck: {
        ...
        ignoredPaths: [
          ...
          'chatSettingStore.config.eventHandlers',
        ],
      },
    })
