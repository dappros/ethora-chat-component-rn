              ...
              <FlatList
                ...
                ListHeaderComponent={
                  <SearchInput
                    ...
                    placeholder="Search..."
                    background={config?.chatListStyles?.searchbackground}
                  />
                }
                style={[styles.chatList, {
                  backgroundColor: config?.chatListStyles?.background || '#FAFAFA'
                }]}
              />

              {!config?.disableRoomMenuModal && <HeaderRoomListMenu
