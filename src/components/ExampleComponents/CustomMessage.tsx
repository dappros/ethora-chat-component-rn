...
export const MessagePhotoContainer = styled.View`
  max-width: 100px;
  margin: 0;
`;

export const SystemMessage = styled.View`
...
const CustomMessageExample = forwardRef<HTMLViewElement, MessageProps>(
  ({message, isUser}, ref) => {
    return (
