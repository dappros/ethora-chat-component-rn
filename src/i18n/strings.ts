...
const en: UiStringTable = {
  ...
  'attach.takePhotoHint': 'Capture with the camera',
  'attach.photoOrVideo': 'Photo or video',
  'attach.photoOrVideoHint': 'Pick from your library',
  'attach.document': 'Document',
  'attach.documentHint': 'Choose a file',
...
const fr: UiStringTable = {
  ...
  'attach.title': 'Joindre',
  'attach.takePhoto': 'Prendre une photo',
  'attach.takePhotoHint': "Capturer avec l'appareil photo",
  'attach.photoOrVideo': 'Photo ou vidéo',
  'attach.photoOrVideoHint': 'Choisir depuis votre bibliothèque',
  'attach.document': 'Document',
  'attach.documentHint': 'Choisir un fichier',
...
const es: UiStringTable = {
  ...
  'attach.title': 'Adjuntar',
  'attach.takePhoto': 'Tomar foto',
  'attach.takePhotoHint': 'Capturar con la cámara',
  'attach.photoOrVideo': 'Foto o video',
  'attach.photoOrVideoHint': 'Elegir de tu galería',
  'attach.document': 'Documento',
  'attach.documentHint': 'Elegir un archivo',
...
const pt: UiStringTable = {
  ...
  'attach.takePhotoHint': 'Capturar com a câmara',
  'attach.photoOrVideo': 'Foto ou vídeo',
  'attach.photoOrVideoHint': 'Escolher da sua biblioteca',
  'attach.document': 'Documento',
  'attach.documentHint': 'Escolher um ficheiro',
...
const ht: UiStringTable = {
  ...
  'attach.takePhotoHint': 'Pran foto ak kamera a',
  'attach.photoOrVideo': 'Foto oswa videyo',
  'attach.photoOrVideoHint': 'Chwazi nan bibliyotèk ou',
  'attach.document': 'Dokiman',
  'attach.documentHint': 'Chwazi yon fichye',
...
const zh: UiStringTable = {
  ...
  'attach.title': '添加附件',
  'attach.takePhoto': '拍照',
  'attach.takePhotoHint': '使用相机拍摄',
  'attach.photoOrVideo': '照片或视频',
  'attach.photoOrVideoHint': '从相册中选择',
  'attach.document': '文档',
  'attach.documentHint': '选择一个文件',
