...
const en: UiStringTable = {
  ...
  'notification.senderFallback': 'New message',
  ...
  'call.title': 'Call',
  'call.unknownCaller': 'Unknown caller',
  ...
  'call.connectingToRoom': 'Connecting to room',
  'call.tryAgainLater': 'Please try again later',
  'call.status.inCall': 'In call',
  'call.status.connecting': 'Connecting...',
  'call.status.waitingForPeer': 'Waiting for the other person',
  'call.status.cameraOff': 'Camera is off',
  'call.action.accept': 'Accept',
  'call.action.decline': 'Decline',
  'call.action.cancel': 'Cancel',
  'call.action.dismiss': 'Dismiss',
  'call.action.hangUp': 'Hang up',
  'call.action.minimize': 'Minimize call',
  'call.action.expand': 'Expand call',
  'call.action.muteMic': 'Mute microphone',
  'call.action.unmuteMic': 'Unmute microphone',
  'call.action.stopCamera': 'Turn camera off',
  'call.action.startCamera': 'Turn camera on',
  'call.action.switchCamera': 'Switch camera',
  'call.action.speakerOn': 'Turn speaker on',
  'call.action.speakerOff': 'Turn speaker off',
  'call.action.startAudioCall': 'Start audio call',
  'call.action.startVideoCall': 'Start video call',
  'call.error.sdkMissing': 'Calls are unavailable: the LiveKit packages are not installed in this app.',
  'call.error.missingConfig': 'Calls are unavailable: missing call token or server URL.',
  'call.error.missingLivekitUrl': 'Calls are unavailable: missing livekitUrl in config.videoCalls',
  'call.error.connectFailed': 'Could not connect to the call',
  'call.error.deviceBlocked': 'Camera/microphone access is blocked. Allow it in Settings, then try again.',
  'call.error.deviceNotFound': 'No camera or microphone found on this device.',
  'call.error.deviceInUse': 'Your camera or microphone is already in use by another app.',
  'call.error.deviceGeneric': 'Could not access your camera or microphone.',
  'call.error.noAnswerTimeout': 'No answer, the call timed out',
  'action.send': 'Send',
  ...
  'action.edit': 'Edit',
  'action.deleteAndLeave': 'Delete and Leave',
  'status.banned': 'banned',
  'action.unban': 'Unban',
  'action.openSettings': 'Open Settings',
  'attach.takePhoto': 'Take photo',
  'attach.photosAndVideos': 'Photos & Videos',
  'attach.viewLibrary': 'View Library',
  'attach.uploadFile': 'Upload a File',
  'permission.requiredTitle': 'Permission required',
  'permission.photoLibrary': 'Photo library permission is needed to select images.',
  'permission.camera': 'Camera permission is needed to take photos and videos.',
  'permission.gallery': 'Gallery permission is needed to select photos and videos.',
  'permission.microphone': 'Microphone permission is needed to record voice messages.',
  ...
  'modal.newChat.roomNamePlaceholder': 'Chat name',
  'modal.newChat.descriptionPlaceholder': 'Description (optional)',
  'modal.newChat.createButton': 'Create new chat',
  'modal.newChat.nameTooShort': 'Chat name must be at least 3 characters.',
  ...
  'toast.roomImageUpdated': 'Room image updated successfully',
  'toast.failedToUploadImage': 'Failed to upload image',
  'toast.chatDeletedSuccess': 'Chat deleted successfully',
  'toast.failedToDeleteChat': 'Failed to delete chat',
  ...
  'modal.profile.media': 'Media',
  'modal.profile.documents': 'Documents',
  'modal.profile.noFiles': 'Nothing here yet',
  ...
  'modal.chatProfile.addMembers': 'Add Members',
  'modal.chatProfile.removePhoto': 'Remove photo',
  'modal.chatProfile.membersLabel': 'Members: {count}',
  'modal.chatProfile.membersUnavailable': 'Member list unavailable',
  'modal.chatProfile.removeMember': 'Remove from this chat?',
  'modal.chatProfile.memberListUnavailable': 'Member list unavailable',
...
const fr: UiStringTable = {
  ...
  'message.newMessages': 'Nouveaux messages',
  'notification.senderFallback': 'Nouveau message',
  ...
  'call.title': 'Appel',
  'call.unknownCaller': 'Appelant inconnu',
  ...
  'call.audioCall': 'Appel audio',
  'call.videoCall': 'Appel vidéo',
  'call.connectingToRoom': 'Connexion au salon',
  'call.tryAgainLater': 'Veuillez réessayer plus tard',
  'call.status.inCall': 'En communication',
  'call.status.connecting': 'Connexion...',
  'call.status.waitingForPeer': 'En attente de votre correspondant',
  'call.status.cameraOff': 'Caméra désactivée',
  'call.action.accept': 'Accepter',
  'call.action.decline': 'Refuser',
  'call.action.cancel': 'Annuler',
  'call.action.dismiss': 'Fermer',
  'call.action.hangUp': 'Raccrocher',
  'call.action.minimize': 'Réduire l\'appel',
  'call.action.expand': 'Agrandir l\'appel',
  'call.action.muteMic': 'Couper le micro',
  'call.action.unmuteMic': 'Activer le micro',
  'call.action.stopCamera': 'Désactiver la caméra',
  'call.action.startCamera': 'Activer la caméra',
  'call.action.switchCamera': 'Changer de caméra',
  'call.action.speakerOn': 'Activer le haut-parleur',
  'call.action.speakerOff': 'Désactiver le haut-parleur',
  'call.action.startAudioCall': 'Démarrer un appel audio',
  'call.action.startVideoCall': 'Démarrer un appel vidéo',
  'call.error.sdkMissing': 'Appels indisponibles : les paquets LiveKit ne sont pas installés dans cette application.',
  'call.error.missingConfig': 'Appels indisponibles : jeton d\'appel ou URL du serveur manquant.',
  'call.error.missingLivekitUrl': 'Appels indisponibles : livekitUrl manquant dans config.videoCalls',
  'call.error.connectFailed': 'Impossible de se connecter à l\'appel',
  'call.error.deviceBlocked': 'L\'accès à la caméra/au micro est bloqué. Autorisez-le dans les réglages, puis réessayez.',
  'call.error.deviceNotFound': 'Aucune caméra ni microphone trouvé sur cet appareil.',
  'call.error.deviceInUse': 'Votre caméra ou microphone est déjà utilisé par une autre application.',
  'call.error.deviceGeneric': 'Impossible d\'accéder à votre caméra ou microphone.',
  'call.error.noAnswerTimeout': 'Pas de réponse, l\'appel a expiré',
  'action.send': 'Envoyer',
  ...
  'action.deleteAndLeave': 'Supprimer et quitter',
  'status.banned': 'banni',
  'action.unban': 'Débannir',
  'action.openSettings': 'Ouvrir les réglages',
  'attach.takePhoto': 'Prendre une photo',
  'attach.photosAndVideos': 'Photos et vidéos',
  'attach.viewLibrary': 'Voir la bibliothèque',
  'attach.uploadFile': 'Téléverser un fichier',
  'permission.requiredTitle': 'Autorisation requise',
  'permission.photoLibrary': "L'autorisation d'accès à la photothèque est nécessaire pour sélectionner des images.",
  'permission.camera': "L'autorisation d'accès à la caméra est nécessaire pour prendre des photos et des vidéos.",
  'permission.gallery': "L'autorisation d'accès à la galerie est nécessaire pour sélectionner des photos et des vidéos.",
  'permission.microphone': "L'autorisation d'accès au microphone est nécessaire pour enregistrer des messages vocaux.",
  ...
  'modal.newChat.descriptionPlaceholder': 'Description (facultatif)',
  'modal.newChat.createButton': 'Créer la discussion',
  'modal.newChat.nameTooShort': 'Le nom doit contenir au moins 3 caractères.',
  ...
  'toast.roomImageUpdated': 'Image du salon mise à jour avec succès',
  'toast.failedToUploadImage': "Échec du téléchargement de l'image",
  'toast.chatDeletedSuccess': 'Discussion supprimée avec succès',
  'toast.failedToDeleteChat': 'Échec de la suppression de la discussion',
  ...
  'modal.profile.language': 'Langue',
  'modal.profile.media': 'Médias',
  'modal.profile.documents': 'Documents',
  'modal.profile.noFiles': 'Rien pour le moment',
  ...
  'modal.chatProfile.addMembers': 'Ajouter des membres',
  'modal.chatProfile.removePhoto': 'Supprimer la photo',
  'modal.chatProfile.membersLabel': 'Membres : {count}',
  'modal.chatProfile.membersUnavailable': 'Liste des membres indisponible',
  'modal.chatProfile.removeMember': 'Retirer de cette discussion ?',
  'modal.chatProfile.memberListUnavailable': 'Liste des membres indisponible',
...
const es: UiStringTable = {
  ...
  'message.newMessages': 'Nuevos mensajes',
  'notification.senderFallback': 'Nuevo mensaje',
  ...
  'call.durationMinSec': '{m} min {s} s',
  'call.title': 'Llamada',
  'call.unknownCaller': 'Llamante desconocido',
  'call.incomingAudio': 'Llamada de audio entrante',
  'call.incomingVideo': 'Videollamada entrante',
  'call.calling': 'Llamando...',
  'call.connecting': 'Conectando...',
  'call.failed': 'Error en la llamada',
  'call.audioCall': 'Llamada de audio',
  'call.videoCall': 'Videollamada',
  'call.connectingToRoom': 'Conectando a la sala',
  'call.tryAgainLater': 'Vuelve a intentarlo más tarde',
  'call.status.inCall': 'En llamada',
  'call.status.connecting': 'Conectando...',
  'call.status.waitingForPeer': 'Esperando a la otra persona',
  'call.status.cameraOff': 'Cámara desactivada',
  'call.action.accept': 'Aceptar',
  'call.action.decline': 'Rechazar',
  'call.action.cancel': 'Cancelar',
  'call.action.dismiss': 'Cerrar',
  'call.action.hangUp': 'Colgar',
  'call.action.minimize': 'Minimizar llamada',
  'call.action.expand': 'Ampliar llamada',
  'call.action.muteMic': 'Silenciar micrófono',
  'call.action.unmuteMic': 'Activar micrófono',
  'call.action.stopCamera': 'Apagar la cámara',
  'call.action.startCamera': 'Encender la cámara',
  'call.action.switchCamera': 'Cambiar de cámara',
  'call.action.speakerOn': 'Activar el altavoz',
  'call.action.speakerOff': 'Desactivar el altavoz',
  'call.action.startAudioCall': 'Iniciar llamada de audio',
  'call.action.startVideoCall': 'Iniciar videollamada',
  'call.error.sdkMissing': 'Llamadas no disponibles: los paquetes de LiveKit no están instalados en esta aplicación.',
  'call.error.missingConfig': 'Llamadas no disponibles: falta el token de llamada o la URL del servidor.',
  'call.error.missingLivekitUrl': 'Llamadas no disponibles: falta livekitUrl en config.videoCalls',
  'call.error.connectFailed': 'No se pudo conectar a la llamada',
  'call.error.deviceBlocked': 'El acceso a la cámara/micrófono está bloqueado. Actívalo en Ajustes y vuelve a intentarlo.',
  'call.error.deviceNotFound': 'No se encontró cámara ni micrófono en este dispositivo.',
  'call.error.deviceInUse': 'Tu cámara o micrófono ya está siendo usado por otra aplicación.',
  'call.error.deviceGeneric': 'No se pudo acceder a tu cámara o micrófono.',
  'call.error.noAnswerTimeout': 'Sin respuesta, la llamada expiró',
  'action.send': 'Enviar',
  ...
  'action.edit': 'Editar',
  'action.deleteAndLeave': 'Eliminar y salir',
  'status.banned': 'bloqueado',
  'action.unban': 'Desbanear',
  'action.openSettings': 'Abrir configuración',
  'attach.takePhoto': 'Tomar foto',
  'attach.photosAndVideos': 'Fotos y videos',
  'attach.viewLibrary': 'Ver galería',
  'attach.uploadFile': 'Subir un archivo',
  'permission.requiredTitle': 'Permiso requerido',
  'permission.photoLibrary': 'Se necesita permiso de acceso a la galería de fotos para seleccionar imágenes.',
  'permission.camera': 'Se necesita permiso de cámara para tomar fotos y videos.',
  'permission.gallery': 'Se necesita permiso de galería para seleccionar fotos y videos.',
  'permission.microphone': 'Se necesita permiso de micrófono para grabar mensajes de voz.',
  ...
  'modal.newChat.descriptionPlaceholder': 'Descripción (opcional)',
  'modal.newChat.createButton': 'Crear chat',
  'modal.newChat.nameTooShort': 'El nombre debe tener al menos 3 caracteres.',
  ...
  'toast.success': '¡Éxito!',
  'toast.successTitle': 'Éxito',
  'toast.roomCreatedSuccess': '¡Sala creada correctamente!',
  'toast.usersAddedSuccess': '¡Usuarios añadidos correctamente!',
  'toast.roomImageUpdated': 'Imagen de la sala actualizada correctamente',
  'toast.failedToUploadImage': 'No se pudo subir la imagen',
  'toast.chatDeletedSuccess': 'Chat eliminado correctamente',
  'toast.failedToDeleteChat': 'No se pudo eliminar el chat',
  ...
  'modal.profile.language': 'Idioma',
  'modal.profile.media': 'Multimedia',
  'modal.profile.documents': 'Documentos',
  'modal.profile.noFiles': 'Todavía no hay nada',
  ...
  'modal.chatProfile.addMembers': 'Añadir miembros',
  'modal.chatProfile.removePhoto': 'Quitar la foto',
  'modal.chatProfile.membersLabel': 'Miembros: {count}',
  'modal.chatProfile.membersUnavailable': 'Lista de miembros no disponible',
  'modal.chatProfile.removeMember': '¿Quitar de este chat?',
  'modal.chatProfile.memberListUnavailable': 'Lista de miembros no disponible',
...
const pt: UiStringTable = {
  ...
  'message.edited': 'editado',
  'message.newMessages': 'Novas mensagens',
  'notification.senderFallback': 'Nova mensagem',
  'presence.online': 'online',
  'presence.offline': 'offline',
  'presence.onlineCount': '{count} online',
  ...
  'call.durationMinSec': '{m} min {s} s',
  'call.title': 'Chamada',
  'call.unknownCaller': 'Chamador desconhecido',
  'call.incomingAudio': 'Chamada de áudio recebida',
  'call.incomingVideo': 'Videochamada recebida',
  'call.calling': 'A chamar...',
  'call.connecting': 'A ligar...',
  'call.failed': 'A chamada falhou',
  'call.audioCall': 'Chamada de áudio',
  'call.videoCall': 'Videochamada',
  'call.connectingToRoom': 'A ligar à sala',
  'call.tryAgainLater': 'Tente novamente mais tarde',
  'call.status.inCall': 'Em chamada',
  'call.status.connecting': 'A ligar...',
  'call.status.waitingForPeer': 'À espera da outra pessoa',
  'call.status.cameraOff': 'Câmara desligada',
  'call.action.accept': 'Atender',
  'call.action.decline': 'Recusar',
  'call.action.cancel': 'Cancelar',
  'call.action.dismiss': 'Fechar',
  'call.action.hangUp': 'Desligar',
  'call.action.minimize': 'Minimizar chamada',
  'call.action.expand': 'Expandir chamada',
  'call.action.muteMic': 'Silenciar microfone',
  'call.action.unmuteMic': 'Ativar microfone',
  'call.action.stopCamera': 'Desligar a câmara',
  'call.action.startCamera': 'Ligar a câmara',
  'call.action.switchCamera': 'Mudar de câmara',
  'call.action.speakerOn': 'Ligar o altifalante',
  'call.action.speakerOff': 'Desligar o altifalante',
  'call.action.startAudioCall': 'Iniciar chamada de áudio',
  'call.action.startVideoCall': 'Iniciar videochamada',
  'call.error.sdkMissing': 'Chamadas indisponíveis: os pacotes LiveKit não estão instalados nesta aplicação.',
  'call.error.missingConfig': 'Chamadas indisponíveis: falta o token da chamada ou o URL do servidor.',
  'call.error.missingLivekitUrl': 'Chamadas indisponíveis: falta livekitUrl em config.videoCalls',
  'call.error.connectFailed': 'Não foi possível ligar à chamada',
  'call.error.deviceBlocked': 'O acesso à câmara/microfone está bloqueado. Ative-o nas Definições e tente novamente.',
  'call.error.deviceNotFound': 'Nenhuma câmara ou microfone encontrado neste dispositivo.',
  'call.error.deviceInUse': 'A sua câmara ou microfone já está a ser utilizado por outra aplicação.',
  'call.error.deviceGeneric': 'Não foi possível aceder à câmara ou microfone.',
  'call.error.noAnswerTimeout': 'Sem resposta, a chamada expirou',
  'action.send': 'Enviar',
  'action.cancel': 'Cancelar',
  'action.save': 'Guardar',
  'action.delete': 'Eliminar',
  ...
  'action.edit': 'Editar',
  'action.deleteAndLeave': 'Eliminar e sair',
  'status.banned': 'banido',
  'action.unban': 'Desbanir',
  'action.openSettings': 'Abrir definições',
  'attach.takePhoto': 'Tirar foto',
  'attach.photosAndVideos': 'Fotos e vídeos',
  'attach.viewLibrary': 'Ver biblioteca',
  'attach.uploadFile': 'Carregar um ficheiro',
  'permission.requiredTitle': 'Permissão necessária',
  'permission.photoLibrary': 'É necessária permissão de acesso à biblioteca de fotos para selecionar imagens.',
  'permission.camera': 'É necessária permissão da câmara para tirar fotos e vídeos.',
  'permission.gallery': 'É necessária permissão da galeria para selecionar fotos e vídeos.',
  'permission.microphone': 'É necessária permissão do microfone para gravar mensagens de voz.',
  ...
  'modal.newChat.descriptionPlaceholder': 'Descrição (opcional)',
  'modal.newChat.createButton': 'Criar conversa',
  'modal.newChat.nameTooShort': 'O nome deve ter pelo menos 3 caracteres.',
  ...
  'toast.successTitle': 'Sucesso',
  'toast.roomCreatedSuccess': 'Sala criada com sucesso!',
  'toast.usersAddedSuccess': 'Utilizadores adicionados com sucesso!',
  'toast.roomImageUpdated': 'Imagem da sala atualizada com sucesso',
  'toast.failedToUploadImage': 'Falha ao carregar a imagem',
  'toast.chatDeletedSuccess': 'Chat eliminado com sucesso',
  'toast.failedToDeleteChat': 'Falha ao eliminar o chat',
  ...
  'modal.profile.language': 'Idioma',
  'modal.profile.media': 'Multimédia',
  'modal.profile.documents': 'Documentos',
  'modal.profile.noFiles': 'Ainda não há nada aqui',
  ...
  'modal.chatProfile.addMembers': 'Adicionar membros',
  'modal.chatProfile.removePhoto': 'Remover foto',
  'modal.chatProfile.membersLabel': 'Membros: {count}',
  'modal.chatProfile.membersUnavailable': 'Lista de membros indisponível',
  'modal.chatProfile.removeMember': 'Remover deste chat?',
  'modal.chatProfile.memberListUnavailable': 'Lista de membros indisponível',
  'modal.deleteChat.title': 'Eliminar este chat?',
...
const ht: UiStringTable = {
  ...
  'message.newMessages': 'Nouvo mesaj yo',
  'notification.senderFallback': 'Nouvo mesaj',
  ...
  'call.title': 'Apèl',
  'call.unknownCaller': 'Moun ki rele a enkoni',
  'call.incomingAudio': 'Apèl odyo antran',
  'call.incomingVideo': 'Apèl videyo antran',
  'call.calling': 'Ap rele...',
  'call.connecting': 'Ap konekte...',
  'call.failed': 'Apèl la echwe',
  'call.audioCall': 'Apèl odyo',
  'call.videoCall': 'Apèl videyo',
  'call.connectingToRoom': 'Ap konekte nan sal la',
  'call.tryAgainLater': 'Tanpri eseye ankò pita',
  'call.status.inCall': 'Nan apèl',
  'call.status.connecting': 'Ap konekte...',
  'call.status.waitingForPeer': 'Ap tann lòt moun nan',
  'call.status.cameraOff': 'Kamera a etenn',
  'call.action.accept': 'Aksepte',
  'call.action.decline': 'Refize',
  'call.action.cancel': 'Anile',
  'call.action.dismiss': 'Fèmen',
  'call.action.hangUp': 'Rakwoche',
  'call.action.minimize': 'Diminye apèl la',
  'call.action.expand': 'Agrandi apèl la',
  'call.action.muteMic': 'Etenn mikwo a',
  'call.action.unmuteMic': 'Limen mikwo a',
  'call.action.stopCamera': 'Etenn kamera a',
  'call.action.startCamera': 'Limen kamera a',
  'call.action.switchCamera': 'Chanje kamera',
  'call.action.speakerOn': 'Limen opalè a',
  'call.action.speakerOff': 'Etenn opalè a',
  'call.action.startAudioCall': 'Kòmanse yon apèl odyo',
  'call.action.startVideoCall': 'Kòmanse yon apèl videyo',
  'call.error.sdkMissing': 'Apèl pa disponib: pakè LiveKit yo pa enstale nan aplikasyon sa a.',
  'call.error.missingConfig': 'Apèl pa disponib: token apèl la oswa URL sèvè a manke.',
  'call.error.missingLivekitUrl': 'Apèl pa disponib: livekitUrl manke nan config.videoCalls',
  'call.error.connectFailed': 'Nou pa t kapab konekte nan apèl la',
  'call.error.deviceBlocked': 'Aksè kamera/mikwofòn bloke. Otorize l nan Paramèt, epi eseye ankò.',
  'call.error.deviceNotFound': 'Pa gen kamera ni mikwofòn jwenn sou aparèy sa a.',
  'call.error.deviceInUse': 'Kamera oswa mikwofòn ou deja ap itilize pa yon lòt app.',
  'call.error.deviceGeneric': 'Nou pa t kapab jwenn aksè nan kamera oswa mikwofòn ou.',
  'call.error.noAnswerTimeout': 'Pa gen repons, apèl la fini',
  'action.send': 'Voye',
  'action.cancel': 'Anile',
  ...
  'action.search': 'Chèche',
  'action.edit': 'Modifye',
  'action.deleteAndLeave': 'Efase epi kite',
  'status.banned': 'bloke',
  'action.unban': 'Retire Ban',
  'action.openSettings': 'Louvri Paramèt yo',
  'attach.takePhoto': 'Pran yon foto',
  'attach.photosAndVideos': 'Foto ak videyo',
  'attach.viewLibrary': 'Wè bibliyotèk la',
  'attach.uploadFile': 'Telechaje yon fichye',
  'permission.requiredTitle': 'Otorizasyon nesesè',
  'permission.photoLibrary': 'Nou bezwen otorizasyon pou aksè nan bibliyotèk foto ou pou chwazi imaj.',
  'permission.camera': 'Nou bezwen otorizasyon kamera pou pran foto ak videyo.',
  'permission.gallery': 'Nou bezwen otorizasyon galri pou chwazi foto ak videyo.',
  'permission.microphone': 'Nou bezwen otorizasyon mikwo pou anrejistre mesaj vokal.',
  ...
  'modal.newChat.descriptionPlaceholder': 'Deskripsyon (opsyonèl)',
  'modal.newChat.createButton': 'Kreye chat la',
  'modal.newChat.nameTooShort': 'Non an dwe gen omwen 3 karaktè.',
  ...
  'toast.success': 'Siksè!',
  'toast.successTitle': 'Siksè',
  'toast.roomCreatedSuccess': 'Sal la kreye avèk siksè!',
  'toast.usersAddedSuccess': 'Itilizatè yo ajoute avèk siksè!',
  'toast.roomImageUpdated': 'Imaj sal la mete ajou avèk siksè',
  'toast.failedToUploadImage': 'Echèk pou telechaje imaj la',
  'toast.chatDeletedSuccess': 'Chat la efase avèk siksè',
  'toast.failedToDeleteChat': 'Echèk pou efase chat la',
  ...
  'modal.profile.language': 'Lang',
  'modal.profile.media': 'Medya',
  'modal.profile.documents': 'Dokiman',
  'modal.profile.noFiles': 'Poko gen anyen',
  ...
  'modal.chatProfile.addMembers': 'Ajoute manm',
  'modal.chatProfile.removePhoto': 'Retire foto a',
  'modal.chatProfile.membersLabel': 'Manm: {count}',
  'modal.chatProfile.membersUnavailable': 'Lis manm yo pa disponib',
  'modal.chatProfile.removeMember': 'Retire nan chat sa a?',
  'modal.chatProfile.memberListUnavailable': 'Lis manm yo pa disponib',
...
const zh: UiStringTable = {
  ...
  'notification.senderFallback': '新消息',
  'presence.online': '在线',
  'presence.offline': '离线',
  ...
  'call.audioCall': '语音通话',
  'call.videoCall': '视频通话',
  'call.connectingToRoom': '正在连接房间',
  'call.tryAgainLater': '请稍后再试',
  'call.status.inCall': '通话中',
  'call.status.connecting': '正在连接…',
  'call.status.waitingForPeer': '正在等待对方',
  'call.status.cameraOff': '摄像头已关闭',
  'call.action.accept': '接听',
  'call.action.decline': '拒接',
  'call.action.cancel': '取消',
  'call.action.dismiss': '关闭',
  'call.action.hangUp': '挂断',
  'call.action.minimize': '最小化通话',
  'call.action.expand': '展开通话',
  'call.action.muteMic': '静音麦克风',
  'call.action.unmuteMic': '取消静音',
  'call.action.stopCamera': '关闭摄像头',
  'call.action.startCamera': '打开摄像头',
  'call.action.switchCamera': '切换摄像头',
  'call.action.speakerOn': '打开扬声器',
  'call.action.speakerOff': '关闭扬声器',
  'call.action.startAudioCall': '发起语音通话',
  'call.action.startVideoCall': '发起视频通话',
  'call.error.sdkMissing': '无法通话：此应用未安装 LiveKit 组件包。',
  'call.error.missingConfig': '无法通话：缺少通话令牌或服务器地址。',
  'call.error.missingLivekitUrl': '无法通话：config.videoCalls 中缺少 livekitUrl',
  'call.error.connectFailed': '无法连接到通话',
  'call.error.deviceBlocked': '摄像头/麦克风访问被阻止。请在设置中允许后重试。',
  'call.error.deviceNotFound': '此设备未找到摄像头或麦克风。',
  'call.error.deviceInUse': '您的摄像头或麦克风正被其他应用占用。',
  'call.error.deviceGeneric': '无法访问您的摄像头或麦克风。',
  'call.error.noAnswerTimeout': '无人接听，通话已超时',
  'action.send': '发送',
  'action.cancel': '取消',
  'action.save': '保存',
  'action.delete': '删除',
  ...
  'action.search': '搜索',
  'action.edit': '编辑',
  'action.deleteAndLeave': '删除并退出',
  'status.banned': '已封禁',
  'action.unban': '解除封禁',
  'action.openSettings': '打开设置',
  'attach.takePhoto': '拍照',
  'attach.photosAndVideos': '照片和视频',
  'attach.viewLibrary': '查看相册',
  'attach.uploadFile': '上传文件',
  'permission.requiredTitle': '需要权限',
  'permission.photoLibrary': '需要照片图库权限才能选择图片。',
  'permission.camera': '需要相机权限才能拍摄照片和视频。',
  'permission.gallery': '需要相册权限才能选择照片和视频。',
  'permission.microphone': '需要麦克风权限才能录制语音消息。',
  ...
  'modal.newChat.descriptionPlaceholder': '描述（可选）',
  'modal.newChat.createButton': '创建聊天',
  'modal.newChat.nameTooShort': '名称至少需要 3 个字符。',
  ...
  'toast.roomImageUpdated': '聊天室图片更新成功',
  'toast.failedToUploadImage': '图片上传失败',
  'toast.chatDeletedSuccess': '聊天已成功删除',
  'toast.failedToDeleteChat': '删除聊天失败',
  ...
  'modal.profile.language': '语言',
  'modal.profile.media': '媒体',
  'modal.profile.documents': '文件',
  'modal.profile.noFiles': '这里还没有内容',
  ...
  'modal.chatProfile.addMembers': '添加成员',
  'modal.chatProfile.removePhoto': '移除图片',
  'modal.chatProfile.membersLabel': '成员：{count}',
  'modal.chatProfile.membersUnavailable': '成员列表不可用',
  'modal.chatProfile.removeMember': '将其移出该聊天？',
  'modal.chatProfile.memberListUnavailable': '成员列表不可用',
