...
const en: UiStringTable = {
  ...
  'action.leave': 'Leave',
  'action.muted': 'Muted',
  'action.unmuted': 'Unmuted',
  'toast.muteFailed': 'Could not update notifications for this chat',
...
const fr: UiStringTable = {
  ...
  'action.muted': 'En sourdine',
  'action.unmuted': 'Activé',
  'toast.muteFailed': 'Impossible de modifier les notifications de ce chat',
  'action.create': 'Créer',
...
const es: UiStringTable = {
  ...
  'action.leave': 'Salir',
  'action.muted': 'Silenciado',
  'action.unmuted': 'Activado',
  'toast.muteFailed': 'No se pudieron cambiar las notificaciones de este chat',
  'action.create': 'Crear',
